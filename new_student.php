	...
	<div class="card card-outline card-primary">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group text-dark">
              <div class="form-group">
                <label for="" class="control-label">ID Etudiant #</label>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-student">Enregistrer</button>
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./index.php?page=student_list">Annuler</a>
  		</div>
  	</div>
	</div>
</div>
<script>
	$('#manage-student').submit(function(e){
		...
		$.ajax({
          ...
          $('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Le code Etudiant existe déja.</div>')
          end_load()
        }
			}
		})

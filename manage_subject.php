...
<div class="container-fluid">
	<form action="" id="manage-subject">
		...
		<div class="form-group">
			<label for="code" class="control-label">Code de Sujet</label>
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						...
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Le code de sujet existe déja.</div>')
						end_load()
					}
				}
			})

...
<div class="container-fluid" id="printable">
	<table width="100%">
		<tr>
			<td width="50%">ID Etudiant #: <b><?php echo $student_code ?></b></td>
			<td width="50%">Classe: <b><?php echo $class ?></b></td>
		</tr>
		<tr>
			<td width="50%">Nom de l'étudiant: <b><?php echo ucwords($name) ?></b></td>
			<td width="50%">Sexe: <b><?php echo ucwords($gender) ?></b></td>
		</tr>
	</table>
	<hr>
...
<div class="modal-footer display p-0 m-0">
        <button type="button" class="btn btn-success" id="print"><i class="fa fa-print"></i> Imprimer</button>
...
<noscript>
	...
	<h3 class="text-center"><b>Résultat de l'étudiant</b></h3>
</noscript>
<script>

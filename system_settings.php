	...
	<div class="card card-outline card-primary">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Nom du Système</label>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-system_settings">Enregistrer</button>
    			<button class="btn btn-flat bg-gradient-secondary mx-2" type="button">Annuler</button>
    		</div>
    	</div>
	</div>
</div>
